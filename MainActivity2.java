    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity2.this, AddActivity1.class);
        ...
        customAdapter = new CustomAdapter2(MainActivity2.this,this, sub_id, sub_title, sub_comment,
                sub_marks);
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                sub_title.add(cursor.getString(1));
                sub_comment.add(cursor.getString(2));
                sub_marks.add(cursor.getString(3));
            }
